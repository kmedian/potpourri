...
meta = {
    'id': "sbmi25", 
    'name': 'Logistic Ridge',
    'descriptions': 'Logistic Regression, L2 penalty (Ridge), SAG solver, standard-normal transformed features.',
    'solver': 'Stochastic Average Gradient descent (SAG)',
    'active': True,
    'keywords': ['binary classification', 'linear regression', 'LogisticRegression'],
    'output_num': 'single',
    'output_scale': 'binary',
    'output_dtype': 'bool',
    'input_num': 'multi',
