...
meta = {
    'id': "sbmi97", 
    'name': 'Logistic Ridge',
    'descriptions': 'Logistic Regression, L2 penalty (Ridge), Singular Value Decomposition to solve inverse with ridge coefficients, standard-normal transformed features.',
    'solver': 'Singular Value Decomposition',
    'active': True,
    'keywords': ['binary classification', 'linear regression', 'RidgeClassifier'],
    'output_num': 'single',
    'output_scale': 'binary',
    'output_dtype': 'bool',
    'input_num': 'multi',
