...
meta = {
    'id': "sbmi96", 
    'name': 'Logistic Ridge',
    'descriptions': 'Logistic Regression, L2 penalty (Ridge), Least-Square equations solver, standard-normal transformed features.',
    'solver': 'Least Square',
    'active': True,
    'keywords': ['binary classification', 'linear regression', 'RidgeClassifier', 'scipy.sparse.linalg.lsqr'],
    'output_num': 'single',
    'output_scale': 'binary',
    'output_dtype': 'bool',
    'input_num': 'multi',
